...
---
  ...
  <!-- Typography-->
  <section id="typography" class="flow">
    <h2>Typography</h2>
    <p>
  ...
  <!-- Accordions -->
  <section id="accordions" class="flow">
    <h2>Accordions</h2>
    <details>
